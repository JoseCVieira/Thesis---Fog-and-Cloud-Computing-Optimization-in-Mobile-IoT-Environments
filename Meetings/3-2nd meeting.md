...
-----------------------------------------------------------------------------------
2015 **An architecture for Load Balancing Techniques for Fog Computing Environment.** ? -> (load balancing)
...
-----------------------------------------------------------------------------------
2017 **Computing Resource Allocation in Three-Tier IoT Fog Networks: A Joint Optimization Approach Combining Stackelberg Game and Matching.** ? -> (resource allocation)
...
- BeesLife Algorithm (BLA) para job scheduling problem em fog;
- Pertende otimizar a distribuição de tasks pelos diversos fog nodes;
- Objetivo: otimizar o trade-off entre CPU execution time e memória alocada.
...
-----------------------------------------------------------------------------------
[143] 2018 **Virtual fog: A virtualization enabled fog computing framework for internet of things.** ✓ [VER]
...
-----------------------------------------------------------------------------------
[231] 2015 **Dynamic service migration and workload scheduling in edge-clouds.** ✓ -> (introdução, não muito importante - o 232 é melhor)
