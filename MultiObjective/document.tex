...
\begin{itemize}
	...
	\item $fP^{En}~-$ matrix $1\times N$ representing the energy price of each fog node per unit\\
	...
	\item $f^{Tx}~-$ matrix $N\times N$ representing the transmitter power between each two nodes\\
