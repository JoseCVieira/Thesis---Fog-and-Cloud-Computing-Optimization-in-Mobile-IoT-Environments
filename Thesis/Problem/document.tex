...
\begin{flalign*}
\begin{aligned}
L^M_q = & \sum_{i\in M} A_i \times \left( \sum_{l\in N}\sum_{k\in N} V_{i,l,k} \left( \frac{m^{Strg}_{i} + m^{Ram}_{i} }{f^B_{l,k} + \epsilon} + f^L_{l,k} \right) + B_i \times t^{Boot}\right), \\[6pt]
