...
& where~ :\\
& C_{Pw} = \sum_{i\in N} P^{Pw}_i \left[ f_i^{iPw} + (f_i^{bPw} - f_i^{iPw}) \times\frac{P_i \times m^{Mips}}{f_i^{Mips}} + f^{Tx}_{i} \sum_{z\in Z}m^B_{l^S_z,l^D_z} \sum_{j\in N} \frac{R_{z, i,j}}{f^B_{i,j}\times b + \epsilon} \right]
\end{aligned}&&&
\end{flalign*}\\[6pt]
...
\begin{flalign*}
\begin{aligned}
& L^T_q = \sum_{i\in M}\sum_{j\in M} A^L_{q,i,j} \sum_{l\in N}\sum_{k\in N} R_{z',l,k} \left( \frac{\sum_{z\in Z} R_{z,l,k} \times m^{NW}_{l^S_z, l^D_z}}{f^B_{l,k}\times b + \epsilon} + f^L_{l,k}\right),\\[6pt]
& l^S_{z'} = i,~ l^D_{z'} = j
\end{aligned}&&&
\end{flalign*}
...
\begin{flalign*}
\begin{aligned}
& L^M_q = \sum_{i\in M} A_{i} \left( \sum_{l\in N}\sum_{k\in N} V_{i,l,k} \left( \frac{m^{Strg}_{i} + m^{Ram}_{i} }{f^B_{l,k} \times (1-b)  + \epsilon} + f^L_{l,k} \right) + t^{Boot}\right),\\[6pt]
& A_i=\begin{cases} 1,~ \sum_{j\in M} A^L_{q, i, j} + A^L_{q, j, i} \ge 1\\ 0,~ Otherwise\end{cases}
\end{aligned}&&&
\end{flalign*}
...
\begin{aligned}
& where:\\
& L^P_q = \sum_{i\in M}\sum_{j\in M} A^L_{q,i,j}\times m^{CPU}_{i,j} \times \sum_{n\in N}  P_{n, j} \frac{\sum_{l\in M} P_{n, l}}{f^{Mips}_n}
\end{aligned}&&&
\end{flalign*}
...
& A_{i,j}=\begin{cases} 1,~ \sum_{z\in Z} R_{z,i,j} + \sum_{m\in M} V_{m,i,j} \ge 1\\ 0,~ Otherwise\end{cases}
\end{aligned}&&&
\end{flalign*}

\begin{flalign*}
\begin{aligned}
& L^T_q = \sum_{i\in M}\sum_{j\in M} A^L_{q,i,j} \sum_{l\in N}\sum_{k\in N} R_{z',l,k} \left( \frac{\sum_{z\in Z} R_{z,l,k} \times m^{NW}_{l^S_z, l^D_z}}{f^B_{l,k} + \epsilon}\right),\\[6pt]
& l^S_{z'} = i,\\[6pt]
& l^D_{z'} = j
\end{aligned}&&&
\end{flalign*}
...
\begin{flalign*}
\begin{aligned}
& L^M_q = \sum_{i\in M} A_{i} \left( \sum_{l\in N}\sum_{k\in N} V_{i,l,k} \left( \frac{ \sum_{j\in M} V_{j,l,k} \times \left(m^{Strg}_{j} + m^{Ram}_{j}\right) }{f^B_{l,k} + \epsilon} \right) + t^{Boot}\right),\\[6pt]
& A_i=\begin{cases} 1,~ \sum_{j\in M} A^L_{q, i, j} + A^L_{q, j, i} \ge 1\\ 0,~ Otherwise\end{cases}
\end{aligned}&&&
\end{flalign*}
